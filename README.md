...
For a more detailed breakdown of how this feature works, read the [implementations](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/Implementation.md#Animated-Star-Background) document.
...
For a more detailed breakdown of how this feature works, read the [implementations](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/Implementation.md#Animated-Asteroid-Sprites) document.
...
For a more detailed breakdown of how this feature works, read the [implementations](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/Implementation.md#player-ship-movement) document.
...
For a more detailed breakdown of how this feature works, read the [implementations](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/Implementation.md#Player-Ship-Controls) document.

### [**Collision Detection**](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/js/script.js#L433)
When the player ship collides with an asteroid, it results in a crash event and the crash screen shows, ending the game. There was a lot of work that went in to the code to create this feature. Please read the [implementations](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/Implementation.md#collision-detection) document for a more detailed breakdown of how the feature works.
...
For a more detailed breakdown of how this feature works, read the [implementations](https://github.com/samlaubscher/Stellar-Drift-Game-M2/blob/master/assets/Implementation.md#Start-Game-Button) document.
